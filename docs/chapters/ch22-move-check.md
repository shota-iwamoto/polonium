...
**S1（use-after-move が無い）** を担当する章です（[safety-spec.md §1](../spec/safety-spec.md)）。
...
仕様は [safety-spec.md §3](../spec/safety-spec.md)、設計は
[design/ownership.md §3〜4](../design/ownership.md) です。**先にそちらを読んでください。**
...
2 つだけです（[design/ownership.md §5](../design/ownership.md)）。
