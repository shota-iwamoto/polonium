...
> **Polonium を「書く」ために来た方へ** — このドキュメント群は
> **コンパイラの作り方**の教材です。言語の使い方だけを知りたい場合は
> **[tutorial.md](tutorial.md)（Polonium 入門）**を読んでください。30 分で読み切れます。

| 順番 | ドキュメント | 内容 |
|---|---|---|
| 0 | [tutorial.md](tutorial.md) | **Polonium 入門** — 言語の使い方（コンパイラを作らない人はこれだけでよい） |
