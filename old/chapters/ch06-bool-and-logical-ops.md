...
（[../spec/language-spec.md](../../docs/spec/language-spec.md) 8 節の差異表 #6）。
...
> — [../design/ir-conventions.md](../../docs/design/ir-conventions.md) 4 節
...
設計文書（[../design/ir-conventions.md](../../docs/design/ir-conventions.md) 6.6 節）で
決めたとおりに書きます。
...
> — [../design/ir-conventions.md](../../docs/design/ir-conventions.md) 1 節
