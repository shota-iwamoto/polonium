...
設計は [ownership.md §6](../../docs/design/ownership.md)、仕様は
[safety-spec.md §6](../../docs/spec/safety-spec.md)。
[memory-model.md](../../docs/design/memory-model.md) の「解放しない」もこの章で改訂しました。
...
設計（[ownership.md §6.3](../../docs/design/ownership.md)）では、Rust に倣って
...
プログラムごと埋め込まれています（[memory-model.md §2](../../docs/design/memory-model.md)）。
...
[safety-spec.md §3.1](../../docs/spec/safety-spec.md) を直しました。**
...
（[ownership.md §8](../../docs/design/ownership.md)）。そのときは**仕様を見直します**。
