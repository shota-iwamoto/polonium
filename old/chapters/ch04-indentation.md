...
仕様書（[../spec/language-spec.md](../../docs/spec/language-spec.md) 6.3）では
...
- **`alloca` / `store` / `load`** — SSA の制約を回避する設計
  → [../design/ir-conventions.md](../../docs/design/ir-conventions.md) 第1節が本番を迎えます
...
**予習**：[../spec/type-system.md](../../docs/spec/type-system.md) の第 2〜7 節と、
