...
仕様は [safety-spec.md §4・§11](../../docs/spec/safety-spec.md)、設計は
[design/ownership.md §2](../../docs/design/ownership.md) です。**先にそちらを読んでください。**
...
「移動済みの値を使っていないか」を見ます（[design/ownership.md §3〜4](../../docs/design/ownership.md)）。
