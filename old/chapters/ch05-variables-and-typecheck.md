...
考える必要がなくなります（[../design/memory-model.md](../../docs/design/memory-model.md) 第6節）。
...
（[../spec/grammar.md](../../docs/spec/grammar.md) 第4節）。
...
**「まず動かす、測ってから直す」**が原則です
（[../spec/type-system.md](../../docs/spec/type-system.md) 7.2）。
...
**この順序が重要です**（[../spec/type-system.md](../../docs/spec/type-system.md) 5.3）。
...
（[../spec/language-spec.md](../../docs/spec/language-spec.md) 3.3）が、
...
**[../design/ir-conventions.md](../../docs/design/ir-conventions.md) 第1節で決めた設計が、
ついに動きます。**
...
>
> — [../design/ir-conventions.md](../../docs/design/ir-conventions.md) 第1節
...
**予習**：[../design/ir-conventions.md](../../docs/design/ir-conventions.md) の
