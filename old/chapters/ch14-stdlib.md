...
| 作らないもの | 理由 |
|---|---|
| ジェネリックな `dict[K, V]` | 利用者定義のジェネリクスは v1 で採用しない（[self-hosting.md](../../docs/design/self-hosting.md) 3.7）。14.6 節で代わりの形を示す |
...
**⚠️ これはセルフホストの必須条件です**（[self-hosting.md](../../docs/design/self-hosting.md) 3.4）。
...
セルフホストではシンボルテーブルが要ります（[self-hosting.md](../../docs/design/self-hosting.md) 3.3）。
...
[self-hosting.md](../../docs/design/self-hosting.md) 3.3 に
...
[self-hosting.md](../../docs/design/self-hosting.md) 3.6 節に記録しました。
...
[design/self-hosting.md](../../docs/design/self-hosting.md) のチェックリストを全部埋める。
**そのために足りない機能を実装します。**
