...
| **循環 import は禁止**（エラーにする） | [self-hosting.md](../../docs/design/self-hosting.md) 3.7 で「ファイル構成を DAG に保つ」と決めてある |
...
- `dict` 相当をどう作るか（線形探索で始めてよい。[self-hosting.md](../../docs/design/self-hosting.md) 3.3）
